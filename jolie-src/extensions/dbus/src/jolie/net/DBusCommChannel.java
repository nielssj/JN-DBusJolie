...
public class DBusCommChannel extends CommChannel {
  ...
  protected void sendImpl(CommMessage message) throws IOException {
    ...
    Object[] values = null;
    try {
      values = DBusMarshalling.valuesToDBus(message.value(), builder);
    } catch (DBusException ex) {
      Logger.getLogger(DBusCommChannel.class.getName()).log(Level.SEVERE, null, ex);
    }
    String typeString = builder.toString();


    System.out.println("sendimpl - Values" + Arrays.deepToString(values));
